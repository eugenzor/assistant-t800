...
@pytest.mark.parametrize(
    "raw",
    ["", "123", "050123456a", "+380501234567", "050 123 4567"],
)
...
@pytest.mark.parametrize("raw", ["", "123", "abcdefghij"])
...
@pytest.mark.parametrize(
    "raw", ["0501234567", "12345678901234", "+380501234567", "050-123-4567"]
)
...
def test_phone_accepts_international_digits():
...
def test_phone_display_value_adds_plus_prefix():
    phone = Phone("380501234567")

    assert phone.display_value == "+380501234567"
    assert str(phone) == "+380501234567"
