...
5. Якщо номер телефону не вдається розпізнати або дата народження не відповідає
формату DD.MM.YYYY, повідом користувача про помилку і попроси виправити дані.
