...
3. КЛЮЧОВЕ ПРАВИЛО: чат і панель — це РІЗНІ області. Дані (будь-який вивід print_text)
показуються на панелі. Після виконання дії коротко підтверджуй виконання результату у чаті.
